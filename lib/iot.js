...
var device = awsIot.device({
    keyPath: 'cert/guyi_dev.private.key',
    certPath: 'cert/guyi_dev.cert.pem',
...
exports.initIoT = function() {
    ...
    device
        .on('connect', function () {
            ...
            device.subscribe('guyi' + '/control');
            device.publish('guyi' + '/signal', JSON.stringify({status: 'connected'}));
        });
...
exports.publish = function(message) {
    device.publish('shuikou' + '/signal', message);
};
